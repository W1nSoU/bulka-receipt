...
date — дата покупки. Конвертуй у g.
  Формати на чеках: DD.MM.YYYY, DD/MM/YYYY, YYYY-MM-DD.

time — час покупки. 24-годинний формат HH:MM.

check_code — унікальний фіскальний ідентифікатор документа.
  ВАЖЛИВО: Не плутай з ФН (номером касового апарату), який однаковий для всіх чеків!
  Шукай: "Фіскальний номер документа", "Номер чека", "ЧЕК №", "КВИТАНЦІЯ №".
  На ПРРО-чеках: зазвичай це довгий цифровий рядок під датою або біля QR-коду.
  Якщо є кілька номерів — бери той, що змінюється від чека до чека.
